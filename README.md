...
| **Platform** | Cloud Run, Go Interlace (proprietary core library) |
| **AI / Agents** | Claude API (Anthropic), Gemini API (Google), local LLMs (e.g. Gemma) |
| **Bioinformatics** | Variant Calling, Sequence Alignment, Sequence Homology, Molecular Modeling, Visualization, Quantification, Annotation |
...
[Gene Ontology](https://www.geneontology.org/) · [HPO](https://hpo.jax.org/) · [Mondo](https://mondo.monarchinitiative.org/) · [GSSO](https://obofoundry.org/ontology/gsso.html) · [OBA](https://github.com/obophenotype/bio-attribute-ontology) · [OBO Foundry](https://obofoundry.org/) · [Reactome](https://reactome.org/) · [STRING DB](https://string-db.org/) · [UniProt](https://www.uniprot.org/) · [NCBI Gene](https://www.ncbi.nlm.nih.gov/gene/)
...
- Agentic systems with tool use and memory for bioinformatics workflows
